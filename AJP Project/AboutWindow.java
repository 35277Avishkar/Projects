...

{
	 ...
	 */
...

		{
			...
			JLabel lblLink = new JLabel("http://mmpolytechnic.edu.in/");
 ...
 @Override
			...
			try 
				{
					...
					Desktop.getDesktop().browse(new URI("http://mmpolytechnic.edu.in/"));
		...
		JLabel lblLicenceMit = new JLabel("Licence GNU GPL v4.0");
